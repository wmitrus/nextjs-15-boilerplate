...
# Generated by setup-env.mjs script
...
Usage:
  node scripts/setup-env.mjs <command> [options]
...
Examples:
  node scripts/setup-env.mjs init
  node scripts/setup-env.mjs create preview
  node scripts/setup-env.mjs all
